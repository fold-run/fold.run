...
<CardGrid>
  <Card title="Unify a federation" icon="puzzle">
  ...
  <Card title="Draw the security boundary" icon="seti:lock">
  ...
  <Card title="Broker credentials" icon="approve-check">
  ...
  <Card title="Protect fragile services" icon="warning">
  ...
  <Card title="Govern vendor MCP servers" icon="setting">
  ...
  <Card title="Discover upstreams automatically" icon="random">
  ...
  <Card title="Expose tools outward, carefully" icon="external">
  ...
  <Card title="Conformant, provably" icon="rocket">
